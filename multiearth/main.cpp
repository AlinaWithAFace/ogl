...
static void output_vertex(int index, int lat, int lon) {
	...
	normal_buffer_data[3 * index] = v[0];
	normal_buffer_data[3 * index + 1] = v[1];
	normal_buffer_data[3 * index + 2] = v[2];
...
void generate_sphere() {
	...
	normal_buffer_data = (GLfloat *) malloc(3 * sphere_num_vertices * sizeof(GLfloat));
	...
	glBufferData(GL_ARRAY_BUFFER, 3 * sizeof(GLfloat) * sphere_num_vertices, normal_buffer_data, GL_STATIC_DRAW);
...
void setup_camera() {
	...
	glm::mat4 V = View;
	glm::mat4 M = Model;
	glm::vec3 LightPosition_worldspace = lightPos;
	...
	glUniform3f(LightPosID, LightPosition_worldspace.x, LightPosition_worldspace.y, LightPosition_worldspace.z);
...
int main(void) {
	...
	texfilename.push_back("big_elevation.bmp");
	texvarname.push_back("tex_elevation");
	texfilename.push_back("big_water.bmp");
	texvarname.push_back("tex_water");
	texfilename.push_back("big_night.bmp");
	texvarname.push_back("tex_night");
	texfilename.push_back("big_clouds.bmp");
	texvarname.push_back("tex_clouds");
	texfilename.push_back("big_earth.bmp");
	texvarname.push_back("tex_color");
